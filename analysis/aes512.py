    ...
    def decrypt(self, KEY, CIPHER, type='hex'):
        ...
        if type in ['hex', '0b', 'b64']:
            ...
            if(len(CIPHER) % block == 0 and len(CIPHER) > 0):
                examine = CIPHER
                while(len(examine) != 0):
                    plain_matrix = self.decryptProcess(examine[:block])
...
if(__name__ == '__main__'):
    ...
    key = 'x3xwdinjyo180g097ck7ewcpokksay491r32r1n05a280jbdvp0m2b1o2jki6xu5'
    msg = 'Checking AES 512 on Python'
    encode = '__all__'      # hex, b64 => base64, 0b => binary
    ...
    # # decode from binary
    y = aes512.decrypt('x3xwdinjyo180g097ck7ewcpokksay491r32r1n05a280jbdvp0m2b1o2jki6xu5', x['0b'], '0b')     
    print(y)